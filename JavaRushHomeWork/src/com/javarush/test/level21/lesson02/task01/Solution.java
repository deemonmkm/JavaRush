...
public class Solution {
    ...
    public static void print(byte[] bytes) {
        ...
        {
            if (Integer.toBinaryString(256 + (int)bytes[i]).length()>8)
            {
                System.out.print(Integer.toBinaryString(256 + (int)bytes[i]).substring(1) + " ");
            }
            else System.out.print(Integer.toBinaryString(256 + (int)bytes[i]) + " ");
        }
        System.out.println();
    }
}
